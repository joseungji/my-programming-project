...
st.markdown(
    "<h1 style='font-size: 3rem; margin-bottom: 0;'>💄 방구석 화장대 스마트 매니저</h1>",
    unsafe_allow_html=True,
)
st.write("탭을 클릭하여 필요한 정보를 깔끔하게 확인하세요.")
...
# assets 폴더 절대 경로 (Streamlit Cloud 호환)
assets_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets")
playlist_data = []  # [(파일명, base64), ...]
if os.path.exists(assets_dir):
    try:
        ...
        for mp3_file in mp3_files:
            ...
            playlist_data.append((mp3_file, b64))
    except Exception:
...
if playlist_data:
    ...
    js_sources = "\n".join(
        [f'<source src="data:audio/mpeg;base64,{b64}" data-name="{name}" type="audio/mpeg">' for name, b64 in playlist_data]
    )
    ...
    components.html(
        ...
        <div class="bgm-container">
            ...
            <span style="font-size:13px; color:#555; min-width:22px; text-align:center;" id="volLabel">70%</span>
            <input type="range" class="bgm-vol" id="vol" min="0" max="100" value="70" title="음량">
